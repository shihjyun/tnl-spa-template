...
{:else}
  <div class="flex mx-auto">
    <a
      ...
      target="_blank"
      class="px-2 hover-change-opacity"
    >
    ...
    <a href="{`https://lineit.line.me/share/ui?url=${shareUrl}`}" target="_blank" class="px-2 hover-change-opacity">
    ...
    <a href="{`https://twitter.com/share?url=${shareUrl}`}" target="_blank" class="px-2 hover-change-opacity">
